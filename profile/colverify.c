...
int main(int argc, char *argv[])
{
	...
	static char histoname[MAXNAMEL+1] = "\000";  /* Optional file to save histogram points to */
	int dosort = 0;
	int dozrep = 0;				/* 1 = print average, 2 = print max */
	static char ccmxname[MAXNAMEL+1] = "\000";  /* Colorimeter Correction Matrix name */
	ccmx *cmx = NULL;					/* Colorimeter Correction Matrix */
	static char gprofname[MAXNAMEL+1] = "\000";  /* Gamut limit profile name */
	icmFile *fp = NULL;
	icmErr err = { 0, { '\000'} };
	icc *icco = NULL;
	xicc *xicco = NULL;
	...
	static char out_name[MAXNAMEL+4+1]; /* VRML/X3D name */
	vrml *wrl = NULL;
