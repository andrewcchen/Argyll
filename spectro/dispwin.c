...
/* Recent SDK's seem to be missing some of the older ColorSync declarations... */
#if MAC_OS_X_VERSION_MIN_REQUIRED < 1060 && MAC_OS_X_VERSION_MAX_ALLOWED >= 1060
# include "OldColorSync.h"
#endif
...
#if defined(UNIX_APPLE) &&  MAC_OS_X_VERSION_MIN_REQUIRED < 101500 \
...
main(int argc, char *argv[]) {
	...
	static char pcname[MAXNAMEL+1] = "\000";	/* CGATS patch color name */
	...
	static char sname[MAXNAMEL+1] = "\000";	/* Current cal save name */
	...
	static char calname[MAXNAMEL+1] = "\000";	/* Calibration file name */
	dispwin *dw;
