...
int main(int argc, char *argv[]) {
	...
	static char ccxxname[MAXNAMEL+1] = "\000";  /* Colorimeter Correction Matrix name */
	...
	static char inname[MAXNAMEL+1] = "\000";	/* Input cgats file base name */
	static char outname[MAXNAMEL+1] = "\000";	/* Output cgats file base name */
	static char calname[MAXNAMEL+1] = "\000";	/* Calibration file name (if any) */
