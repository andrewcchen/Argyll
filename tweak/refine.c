...
main(int argc, char *argv[]) {
	...
	static char dev_name[MAXNAMEL+1];	/* Output device ICC filename for gamut */
	static char rd_name[MAXNAMEL+1];	/* Abstract profile ICC to modify */
	static char wr_name[MAXNAMEL+1];	/* Modified/created abstract profile ICC */
