...
main(int argc, char *argv[]) {
	...
	static char prof_name[MAXNAMEL+1] = { '\000' };	/* ICC profile name, "" if none */
	static char in_name[MAXNAMEL+1];			/* TIFF input file */
	static char *xl = NULL, out_name[MAXNAMEL+4+1] = "locus.ts";	/* locus output file */
	int verb = 0;
	int dovrml = 0;
	int doaxes = 1;
	int usevec = 0;
